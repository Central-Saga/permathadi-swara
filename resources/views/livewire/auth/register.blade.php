<x-layouts.auth>
    <div class="flex flex-col gap-6">
        ...
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <flux:link :href="route('login')" wire:navigate class="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-medium">{{ __('Log in') }}</flux:link>
        </div>
    </div>
</x-layouts.auth>
