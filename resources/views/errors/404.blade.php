...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-white antialiased dark:bg-gray-900">
        <div class="relative isolate flex min-h-svh flex-col items-center justify-center gap-6 overflow-hidden p-6 md:p-10">
            ...
            <div aria-hidden="true" class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" data-gsap="error-404-blur-1">
            ...
            <div aria-hidden="true" class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" data-gsap="error-404-blur-2">
                <div style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
            ...
            <div class="flex w-full max-w-2xl flex-col items-center gap-6 text-center">
                <!-- Search Icon -->
                <div class="flex justify-center" data-gsap="error-404-icon">
                    <div class="relative">
                ...
                <!-- Error Code -->
                <h1 class="text-7xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-9xl" data-gsap="error-404-title">
                    404
                </h1>

                <!-- Error Message -->
                <p class="text-3xl font-semibold leading-8 text-gray-900 dark:text-white sm:text-4xl" data-gsap="error-404-subtitle">
                    Halaman Tidak Ditemukan
                </p>

                <!-- Explanation -->
                <p class="text-base leading-7 text-gray-600 dark:text-gray-400 sm:text-lg max-w-md" data-gsap="error-404-description">
                    Maaf, halaman yang Anda cari tidak ditemukan. Halaman mungkin telah dipindahkan, dihapus, atau URL yang Anda masukkan salah.
                </p>

                <!-- Action Buttons -->
                <div class="flex items-center justify-center gap-x-4 mt-4" data-gsap="error-404-actions">
                    <a href="{{ route('home') }}"
