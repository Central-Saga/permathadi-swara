<div class="relative isolate pt-14">
    <div aria-hidden="true" class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" data-gsap="kontak-hero-blur-1">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h1
                    ...
                    data-gsap="kontak-hero-title">
                    Kontak Kami
                </h1>
                <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400" data-gsap="kontak-hero-description">
