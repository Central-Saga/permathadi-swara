<footer class="bg-white dark:bg-gray-900" data-gsap="footer">
    <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div class="flex justify-center gap-x-6 md:order-2">
            <a href="https://www.instagram.com/sps_pedungan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">
            ...
            <a href="https://www.youtube.com/@SanggartabuhPermatadhiswara" class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">
        ...
        <p class="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0 dark:text-gray-400">&copy; {{ date('Y') }} Permathadi Swara. All rights reserved.</p>
    </div>
</footer>
