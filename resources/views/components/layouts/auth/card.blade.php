...
<body class="min-h-screen bg-white antialiased dark:bg-gray-900">
    <div class="relative isolate flex min-h-svh flex-col items-center justify-center gap-6 overflow-hidden p-6 md:p-10">
        ...
        <div
            class="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] dark:bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)]">
        </div>
        ...
        <div class="flex w-full max-w-md flex-col gap-6">
            ...
            <div class="flex flex-col gap-6">
                <div
                    class="group relative rounded-2xl border border-gray-200/50 bg-white/80 backdrop-blur-xl dark:bg-gray-900/80 dark:border-gray-700/50 text-gray-900 dark:text-white shadow-2xl shadow-orange-500/10 ring-1 ring-gray-900/5 dark:ring-white/10 transition-all duration-300 hover:shadow-orange-500/20">
                    <!-- Glow effect -->
                    <div
                        class="absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-orange-500/20 via-red-500/20 to-orange-500/20 opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-100 -z-10">
                    </div>
